...
run_sdk(data = test_dt$nam, map_output = FALSE)
...
# 
# testdt <- readRDS("C:/Users/Bruno/Downloads/Namibia__Generate_Avian_Cluster_Metrics__2024-07-23_10-18-38(1).rds")
# out <- rFunction(testdt, map_output = TRUE)
# 
# 
# 
# library(tmap)
